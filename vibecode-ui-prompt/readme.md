...
```
"Build a login form. Use the [1. The Essentials] rules from the Glassmorphism style and combine with [3. Option B: Dark Mode] for styling."
```
...
```
"Build a personal portfolio. Use Modern Retro Y2K Grainy Texture style with [1. The Essentials] and apply grain effects and geometric shapes."
```
